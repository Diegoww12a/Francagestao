      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-gray-800 border border-yellow-500/30 rounded-lg p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-white">Pendentes ({pendingTasks.length})</h3>
          </div>
        ...
        <div className="bg-gray-800 border border-red-500/30 rounded-lg p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-white">Urgentes ({urgentTasks.length})</h3>
          </div>
          <div className="space-y-3">
        ...
        <div className="bg-gray-800 border border-green-500/30 rounded-lg p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-white">Concluídas ({completedTasks.length})</h3>
          </div>
          <div className="space-y-3">
...
function TaskCard({ task, onUpdateStatus, onDelete }: {
  task: Task;
  onUpdateStatus: (id: string, status: 'pending' | 'completed' | 'urgent') => void;
    ...
    <div className="bg-gray-900 border border-gray-700 rounded-lg p-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          {task.status !== 'urgent' && task.status !== 'completed' && (
            <button
              onClick={() => onUpdateStatus(task.id, 'urgent')}
