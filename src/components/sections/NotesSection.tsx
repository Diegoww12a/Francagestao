...
export default function NotesSection() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold text-white">Anotações Rápidas</h2>
        <p className="text-gray-400 mt-1">Mantenha suas ideias e lembretes organizados</p>
      </div>
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
        ...
        <div className="space-y-3">
          <textarea
            ...
            className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-blue-500 h-32 resize-none"
          />
          <button
            onClick={addNote}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {editingId === note.id ? (
              <div className="space-y-2">
                <textarea
                  ...
                  className="w-full bg-gray-900 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-blue-500 h-24 resize-none"
                />
                <div className="flex gap-2">
                  <button
        ...
        {notes.length === 0 && (
          <div className="col-span-3 text-center py-12">
            <p className="text-gray-500">Nenhuma anotação criada</p>
          </div>
        )}
      </div>
    </div>
